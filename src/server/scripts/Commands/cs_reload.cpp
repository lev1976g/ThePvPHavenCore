...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand reloadCommandTable[] =
        {
			...
			{ "gameobject_template",     SEC_ADMINISTRATOR, true,  &HandleReloadTemplatesGameobjectCommand,    "", NULL },
			...
			{ "item_template",           SEC_ADMINISTRATOR, true,  &HandleReloadTemplatesItemCommand,          "", NULL },
    ...
    static bool HandleReloadCreatureTemplateCommand(ChatHandler* handler, const char* args)
    {
        ...
        handler->SendGlobalGMSysMessage("`creature_template` reloaded.");
        return true;
    }
	...
	static bool HandleReloadTemplatesGameobjectCommand(ChatHandler* handler, const char* /*args*/)
    {
        sObjectMgr->LoadGameObjectTemplate();
        handler->SendGlobalGMSysMessage("`gameobject_template` reloaded.");
        return true;
    }
	...
	static bool HandleReloadTemplatesItemCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        handler->SendGlobalGMSysMessage("`item_template` reloaded.");
        return true;
    }
